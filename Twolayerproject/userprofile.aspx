<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="Twolayerproject.userprofile" %>
                            ...
                            <ItemTemplate>
                                <table class="auto-style3">
                                    ...
                                    <tr>
                                        <td class="auto-style2">Photo</td>
                                        <td class="auto-style2">
                                            <asp:Image ID="Image2" runat="server" Height="106px" ImageUrl='<%# Eval("Photo") %>' Width="108px" />
                                        </td>
                                        <td class="auto-style2"></td>
                                        <td class="auto-style2"></td>
                                        <td class="auto-style2"></td>
